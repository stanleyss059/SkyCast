      ...
      <SafeAreaView style={styles.safeContainer}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          <View style={styles.content}>
            <View style={styles.contentBox}><Text style={styles.contentText}>{location}</Text></View>
            <View style={styles.contentBox}><Text style={styles.contentText}>Weather Details</Text></View>
          </View>
        </ScrollView>
